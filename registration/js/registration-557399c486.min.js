...
e.preventDefault(),e.stopPropagation(),this.transitionTime(),this.initiated=!0,this.moved=!1,this.lastPointX=i.pageX,this.lastPointY=i.pageY,this.startTime=r.getTime(),this.options.disableTouch||r.addEvent(t,"touchmove",this),this.options.disablePointer||r.addEvent(t,r.prefixPointerEvent("pointermove"),this),this.options.disableMouse||r.addEvent(t,"mousemove",this),this.scroller._execEvent("beforeScrollStart")},_move:function(t){{var e,i,s,o,n=t.touches?t.touches[0]:t;r.getTime()}this.moved||this.scroller._execEvent("scrollStart"),this.moved=!0,e=n.pageX-this.lastPointX,this.lastPointX=n.pageX,i=n.pageY-this.lastPointY,this.lastPointY=n.pageY,s=this.x+e,o=this.y+i,this._pos(s,o),t.preventDefault(),t.stopPropagation()},_end:function(e){if(this.initiated){if(this.initiated=!1,e.preventDefault(),e.stopPropagation(),r.removeEvent(t,"touchmove",this),r.removeEvent(t,r.prefixPointerEvent("pointermove"),this),r.removeEvent(t,"mousemove",this),this.scroller.options.snap){var s=this.scroller._nearestSnap(this.scroller.x,this.scroller.y),o=this.options.snapSpeed||i.max(i.max(i.min(i.abs(this.scroller.x-s.x),1e3),i.min(i.abs(this.scroller.y-s.y),1e3)),300);(this.scroller.x!=s.x||this.scroller.y!=s.y)&&(this.scroller.directionX=0,this.scroller.directionY=0,this.scroller.currentPage=s,this.scroller.scrollTo(s.x,s.y,o,this.scroller.options.bounceEasing))}this.moved&&this.scroller._execEvent("scrollEnd")}},transitionTime:function(t){t=t||0,this.indicatorStyle[r.style.transitionDuration]=t+"ms",!t&&r.isBadAndroid&&(this.indicatorStyle[r.style.transitionDuration]="0.001s")},transitionTimingFunction:function(t){this.indicatorStyle[r.style.transitionTimingFunction]=t},refresh:function(){this.transitionTime(),this.indicatorStyle.display=this.options.listenX&&!this.options.listenY?this.scroller.hasHorizontalScroll?"block":"none":this.options.listenY&&!this.options.listenX?this.scroller.hasVerticalScroll?"block":"none":this.scroller.hasHorizontalScroll||this.scroller.hasVerticalScroll?"block":"none",this.scroller.hasHorizontalScroll&&this.scroller.hasVerticalScroll?(r.addClass(this.wrapper,"iScrollBothScrollbars"),r.removeClass(this.wrapper,"iScrollLoneScrollbar"),this.options.defaultScrollbars&&this.options.customStyle&&(this.options.listenX?this.wrapper.style.right="8px":this.wrapper.style.bottom="8px")):(r.removeClass(this.wrapper,"iScrollBothScrollbars"),r.addClass(this.wrapper,"iScrollLoneScrollbar"),this.options.defaultScrollbars&&this.options.customStyle&&(this.options.listenX?this.wrapper.style.right="2px":this.wrapper.style.bottom="2px"));this.wrapper.offsetHeight;this.options.listenX&&(this.wrapperWidth=this.wrapper.clientWidth,this.options.resize?(this.indicatorWidth=i.max(i.round(this.wrapperWidth*this.wrapperWidth/(this.scroller.scrollerWidth||this.wrapperWidth||1)),8),this.indicatorStyle.width=this.indicatorWidth+"px"):this.indicatorWidth=this.indicator.clientWidth,this.maxPosX=this.wrapperWidth-this.indicatorWidth,"clip"==this.options.shrink?(this.minBoundaryX=-this.indicatorWidth+8,this.maxBoundaryX=this.wrapperWidth-8):(this.minBoundaryX=0,this.maxBoundaryX=this.maxPosX),this.sizeRatioX=this.options.speedRatioX||this.scroller.maxScrollX&&this.maxPosX/this.scroller.maxScrollX),this.options.listenY&&(this.wrapperHeight=this.wrapper.clientHeight,this.options.resize?(this.indicatorHeight=i.max(i.round(this.wrapperHeight*this.wrapperHeight/(this.scroller.scrollerHeight||this.wrapperHeight||1)),8),this.indicatorStyle.height=this.indicatorHeight+"px"):this.indicatorHeight=this.indicator.clientHeight,this.maxPosY=this.wrapperHeight-this.indicatorHeight,"clip"==this.options.shrink?(this.minBoundaryY=-this.indicatorHeight+8,this.maxBoundaryY=this.wrapperHeight-8):(this.minBoundaryY=0,this.maxBoundaryY=this.maxPosY),this.maxPosY=this.wrapperHeight-this.indicatorHeight,this.sizeRatioY=this.options.speedRatioY||this.scroller.maxScrollY&&this.maxPosY/this.scroller.maxScrollY),this.updatePosition()},updatePosition:function(){var t=this.options.listenX&&i.round(this.sizeRatioX*this.scroller.x)||0,e=this.options.listenY&&i.round(this.sizeRatioY*this.scroller.y)||0;this.options.ignoreBoundaries||(t<this.minBoundaryX?("scale"==this.options.shrink&&(this.width=i.max(this.indicatorWidth+t,8),this.indicatorStyle.width=this.width+"px"),t=this.minBoundaryX):t>this.maxBoundaryX?"scale"==this.options.shrink?(this.width=i.max(this.indicatorWidth-(t-this.maxPosX),8),this.indicatorStyle.width=this.width+"px",t=this.maxPosX+this.indicatorWidth-this.width):t=this.maxBoundaryX:"scale"==this.options.shrink&&this.width!=this.indicatorWidth&&(this.width=this.indicatorWidth,this.indicatorStyle.width=this.width+"px"),e<this.minBoundaryY?("scale"==this.options.shrink&&(this.height=i.max(this.indicatorHeight+3*e,8),this.indicatorStyle.height=this.height+"px"),e=this.minBoundaryY):e>this.maxBoundaryY?"scale"==this.options.shrink?(this.height=i.max(this.indicatorHeight-3*(e-this.maxPosY),8),this.indicatorStyle.height=this.height+"px",e=this.maxPosY+this.indicatorHeight-this.height):e=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=t,this.y=e,this.scroller.options.useTransform?this.indicatorStyle[r.style.transform]="translate("+t+"px,"+e+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=t+"px",this.indicatorStyle.top=e+"px")},_pos:function(t,e){0>t?t=0:t>this.maxPosX&&(t=this.maxPosX),0>e?e=0:e>this.maxPosY&&(e=this.maxPosY),t=this.options.listenX?i.round(t/this.sizeRatioX):this.scroller.x,e=this.options.listenY?i.round(e/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(t,e)},fade:function(t,e){if(!e||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var i=t?250:500,s=t?0:300;t=t?"1":"0",this.wrapperStyle[r.style.transitionDuration]=i+"ms",this.fadeTimeout=setTimeout(function(t){this.wrapperStyle.opacity=t,this.visible=+t}.bind(this,t),s)}}},s.utils=r,"undefined"!=typeof module&&module.exports?module.exports=s:t.IScroll=s}(window,document,Math),function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}(function(t){function e(){var e=this;e.top="auto",e.left="auto",e.right="auto",e.bottom="auto",e.set=function(i,s){t.isNumeric(s)&&(e[i]=Math.round(s))}}function i(t,e,i){function s(s,o){a(),t.data(g)||(s?(o&&t.data(v,!0),i.showTip(t)):(E.tipOpenImminent=!0,l=setTimeout(function(){l=null,n()},e.intentPollInterval)))}function o(s){a(),E.tipOpenImminent=!1,t.data(g)&&(t.data(v,!1),s?i.hideTip(t):(E.delayInProgress=!0,l=setTimeout(function(){l=null,i.hideTip(t),E.delayInProgress=!1},e.closeDelay)))}function n(){var o=Math.abs(E.previousX-E.currentX),n=Math.abs(E.previousY-E.currentY),a=o+n;a<e.intentSensitivity?i.showTip(t):(E.previousX=E.currentX,E.previousY=E.currentY,s())}function a(){l=clearTimeout(l),E.delayInProgress=!1}function r(){i.resetPosition(t)}var l=null;this.show=s,this.hide=o,this.cancel=a,this.resetPosition=r}function s(){function t(t,o,a,r,l){var h,c=o.split("-")[0],p=new e;switch(h=n(t)?s(t,c):i(t,c),o){case"n":p.set("left",h.left-a/2),p.set("bottom",E.windowHeight-h.top+l);break;case"e":p.set("left",h.left+l),p.set("top",h.top-r/2);break;case"s":p.set("left",h.left-a/2),p.set("top",h.top+l);break;case"w":p.set("top",h.top-r/2),p.set("right",E.windowWidth-h.left+l);break;case"nw":p.set("bottom",E.windowHeight-h.top+l),p.set("right",E.windowWidth-h.left-20);break;case"nw-alt":p.set("left",h.left),p.set("bottom",E.windowHeight-h.top+l);break;case"ne":p.set("left",h.left-20),p.set("bottom",E.windowHeight-h.top+l);break;case"ne-alt":p.set("bottom",E.windowHeight-h.top+l),p.set("right",E.windowWidth-h.left);break;case"sw":p.set("top",h.top+l),p.set("right",E.windowWidth-h.left-20);break;case"sw-alt":p.set("left",h.left),p.set("top",h.top+l);break;case"se":p.set("left",h.left-20),p.set("top",h.top+l);break;case"se-alt":p.set("top",h.top+l),p.set("right",E.windowWidth-h.left)}return p}function i(t,e){var i,s,o=t.offset(),n=t.outerWidth(),a=t.outerHeight();switch(e){case"n":i=o.left+n/2,s=o.top;break;case"e":i=o.left+n,s=o.top+a/2;break;case"s":i=o.left+n/2,s=o.top+a;break;case"w":i=o.left,s=o.top+a/2;break;case"nw":i=o.left,s=o.top;break;case"ne":i=o.left+n,s=o.top;break;case"sw":i=o.left,s=o.top+a;break;case"se":i=o.left+n,s=o.top+a}return{top:s,left:i}}function s(t,e){function i(){m.push(h.matrixTransform(p))}var s,o,n,a,r=t.closest("svg")[0],l=t[0],h=r.createSVGPoint(),c=l.getBBox(),p=l.getScreenCTM(),d=c.width/2,u=c.height/2,m=[],f=["nw","n","ne","e","se","s","sw","w"];if(h.x=c.x,h.y=c.y,i(),h.x+=d,i(),h.x+=d,i(),h.y+=u,i(),h.y+=u,i(),h.x-=d,i(),h.x-=d,i(),h.y-=u,i(),m[0].y!==m[1].y||m[0].x!==m[7].x)for(o=Math.atan2(p.b,p.a)*k,n=Math.ceil((o%360-22.5)/45),1>n&&(n+=8);n--;)f.push(f.shift());for(a=0;a<m.length;a++)if(f[a]===e){s=m[a];break}return{top:s.y+E.scrollTop,left:s.x+E.scrollLeft}}this.compute=t}function o(i){function o(t){t.data(g,!0),k.queue(function(e){n(t),e()})}function n(t){var e;if(t.data(g)){if(E.isTipOpen)return E.isClosing||a(E.activeHover),void k.delay(100).queue(function(e){n(t),e()});t.trigger("powerTipPreRender"),e=h(t),e&&(k.empty().append(e),t.trigger("powerTipRender"),E.activeHover=t,E.isTipOpen=!0,k.data(b,i.mouseOnToPopup),i.followMouse?r():(w(t),E.isFixedTipOpen=!0),k.fadeIn(i.fadeInTime,function(){E.desyncTimeout||(E.desyncTimeout=setInterval(S,500)),t.trigger("powerTipOpen")}))}}function a(t){E.isClosing=!0,E.activeHover=null,E.isTipOpen=!1,E.desyncTimeout=clearInterval(E.desyncTimeout),t.data(g,!1),t.data(v,!1),k.fadeOut(i.fadeOutTime,function(){var s=new e;E.isClosing=!1,E.isFixedTipOpen=!1,k.removeClass(),s.set("top",E.currentY+i.offset),s.set("left",E.currentX+i.offset),k.css(s),t.trigger("powerTipClose")})}function r(){if(!E.isFixedTipOpen&&(E.isTipOpen||E.tipOpenImminent&&k.data(y))){var t,s,o=k.outerWidth(),n=k.outerHeight(),a=new e;a.set("top",E.currentY+i.offset),a.set("left",E.currentX+i.offset),t=c(a,o,n),t!==Y.none&&(s=p(t),1===s?t===Y.right?a.set("left",E.windowWidth-o):t===Y.bottom&&a.set("top",E.scrollTop+E.windowHeight-n):(a.set("left",E.currentX-o-i.offset),a.set("top",E.currentY-n-i.offset))),k.css(a)}}function w(e){var s,o;i.smartPlacement?(s=t.fn.powerTip.smartPlacementLists[i.placement],t.each(s,function(t,i){var s=c(x(e,i),k.outerWidth(),k.outerHeight());return o=i,s===Y.none?!1:void 0})):(x(e,i.placement),o=i.placement),k.addClass(o)}function x(t,s){var o,n,a=0,r=new e;r.set("top",0),r.set("left",0),k.css(r);do o=k.outerWidth(),n=k.outerHeight(),r=T.compute(t,s,o,n,i.offset),k.css(r);while(++a<=5&&(o!==k.outerWidth()||n!==k.outerHeight()));return r}function S(){var t=!1;!E.isTipOpen||E.isClosing||E.delayInProgress||(E.activeHover.data(g)===!1||E.activeHover.is(":disabled")?t=!0:l(E.activeHover)||E.activeHover.is(":focus")||E.activeHover.data(v)||(k.data(b)?l(k)||(t=!0):t=!0),t&&a(E.activeHover))}var T=new s,k=t("#"+i.popupId);0===k.length&&(k=t("<div/>",{id:i.popupId}),0===m.length&&(m=t("body")),m.append(k)),i.followMouse&&(k.data(y)||(d.on("mousemove",r),u.on("scroll",r),k.data(y,!0))),i.mouseOnToPopup&&k.on({mouseenter:function(){k.data(b)&&E.activeHover&&E.activeHover.data(f).cancel()},mouseleave:function(){E.activeHover&&E.activeHover.data(f).hide()}}),this.showTip=o,this.hideTip=a,this.resetPosition=w}function n(t){return window.SVGElement&&t[0]instanceof SVGElement}function a(){E.mouseTrackingActive||(E.mouseTrackingActive=!0,t(function(){E.scrollLeft=u.scrollLeft(),E.scrollTop=u.scrollTop(),E.windowWidth=u.width(),E.windowHeight=u.height()}),d.on("mousemove",r),u.on({resize:function(){E.windowWidth=u.width(),E.windowHeight=u.height()},scroll:function(){var t=u.scrollLeft(),e=u.scrollTop();t!==E.scrollLeft&&(E.currentX+=t-E.scrollLeft,E.scrollLeft=t),e!==E.scrollTop&&(E.currentY+=e-E.scrollTop,E.scrollTop=e)}}))}function r(t){E.currentX=t.pageX,E.currentY=t.pageY}function l(t){var e=t.offset(),i=t[0].getBoundingClientRect(),s=i.right-i.left,o=i.bottom-i.top;return E.currentX>=e.left&&E.currentX<=e.left+s&&E.currentY>=e.top&&E.currentY<=e.top+o}function h(e){var i,s,o=e.data(x),n=e.data(S),a=e.data(T);return o?(t.isFunction(o)&&(o=o.call(e[0])),s=o):n?(t.isFunction(n)&&(n=n.call(e[0])),n.length>0&&(s=n.clone(!0,!0))):a&&(i=t("#"+a),i.length>0&&(s=i.html())),s}function c(t,e,i){var s=E.scrollTop,o=E.scrollLeft,n=s+E.windowHeight,a=o+E.windowWidth,r=Y.none;return(t.top<s||Math.abs(t.bottom-E.windowHeight)-i<s)&&(r|=Y.top),(t.top+i>n||Math.abs(t.bottom-E.windowHeight)>n)&&(r|=Y.bottom),(t.left<o||t.right+e>a)&&(r|=Y.left),(t.left+e>a||t.right<o)&&(r|=Y.right),r}function p(t){for(var e=0;t;)t&=t-1,e++;return e}var d=t(document),u=t(window),m=t("body"),f="displayController",g="hasActiveHover",v="forcedOpen",y="hasMouseMove",b="mouseOnToPopup",w="originalTitle",x="powertip",S="powertipjq",T="powertiptarget",k=180/Math.PI,E={isTipOpen:!1,isFixedTipOpen:!1,isClosing:!1,tipOpenImminent:!1,activeHover:null,currentX:0,currentY:0,previousX:0,previousY:0,desyncTimeout:null,mouseTrackingActive:!1,delayInProgress:!1,windowWidth:0,windowHeight:0,scrollTop:0,scrollLeft:0},Y={none:0,top:1,bottom:2,left:4,right:8};t.fn.powerTip=function(e,s){if(!this.length)return this;if("string"===t.type(e)&&t.powerTip[e])return t.powerTip[e].call(this,this,s);var n=t.extend({},t.fn.powerTip.defaults,e),r=new o(n);return a(),this.each(function(){var e,s=t(this),o=s.data(x),a=s.data(S),l=s.data(T);s.data(f)&&t.powerTip.destroy(s),e=s.attr("title"),o||l||a||!e||(s.data(x,e),s.data(w,e),s.removeAttr("title")),s.data(f,new i(s,n,r))}),n.manual||this.on({"mouseenter.powertip":function(e){t.powerTip.show(this,e)},"mouseleave.powertip":function(){t.powerTip.hide(this)},"focus.powertip":function(){t.powerTip.show(this)},"blur.powertip":function(){t.powerTip.hide(this,!0)},"keydown.powertip":function(e){27===e.keyCode&&t.powerTip.hide(this,!0)}}),this},t.fn.powerTip.defaults={fadeInTime:200,fadeOutTime:100,followMouse:!1,popupId:"powerTip",intentSensitivity:7,intentPollInterval:100,closeDelay:100,placement:"n",smartPlacement:!1,offset:10,mouseOnToPopup:!1,manual:!1},t.fn.powerTip.smartPlacementLists={n:["n","ne","nw","s"],e:["e","ne","se","w","nw","sw","n","s","e"],s:["s","se","sw","n"],w:["w","nw","sw","e","ne","se","n","s","w"],nw:["nw","w","sw","n","s","se","nw"],ne:["ne","e","se","n","s","sw","ne"],sw:["sw","w","nw","s","n","ne","sw"],se:["se","e","ne","s","n","nw","se"],"nw-alt":["nw-alt","n","ne-alt","sw-alt","s","se-alt","w","e"],"ne-alt":["ne-alt","n","nw-alt","se-alt","s","sw-alt","e","w"],"sw-alt":["sw-alt","s","se-alt","nw-alt","n","ne-alt","w","e"],"se-alt":["se-alt","s","sw-alt","ne-alt","n","nw-alt","e","w"]},t.powerTip={show:function(e,i){return i?(r(i),E.previousX=i.pageX,E.previousY=i.pageY,t(e).data(f).show()):t(e).first().data(f).show(!0,!0),e},reposition:function(e){return t(e).first().data(f).resetPosition(),e},hide:function(e,i){return e?t(e).first().data(f).hide(i):E.activeHover&&E.activeHover.data(f).hide(!0),e},destroy:function(e){return t(e).off(".powertip").each(function(){var e=t(this),i=[w,f,g,v];e.data(w)&&(e.attr("title",e.data(w)),i.push(x)),e.removeData(i)}),e}},t.powerTip.showTip=t.powerTip.show,t.powerTip.closeTip=t.powerTip.hide}),function(t){function e(t){return t.charAt(0).toUpperCase()+t.slice(1)}function i(){this.rooms=dataReg.roomData,this.seatLimit=seatLimit,this.currentRoom=0,this.css3=!1,this.ie8=!1,this.mobileview=!0,this.bronSeats=null,this.openSeats=null,this.seatsTotal=null,this.takenSeats=null,this.locationObj={},this.selectedSeats=[],this.customF=[],this.gmailNeeded=gmail,this.status=regTime,this.spotName=y.translate("seat")}function s(t,e,i,s){this.id=t,this.nr=e,this.room=i,this.roomUUID=s,this.defFields=["FirstName","LastName","Email"],this.customFields=[]}function o(){new Date-x<T?setTimeout(o,T):(S=!1,b=t(window).width(),w=t(window).height(),b>1024?(D.mobileview=!1,t("#room-nav").hasClass("modal")&&(t("#room-nav").removeClass("modal"),t("#modal-bg").css("display","none"))):D.mobileview=!0,n(D.rooms[D.currentRoom].room.width,D.rooms[D.currentRoom].room.height),null!=E&&(E.destroy(),E=null),a())}function n(e,i){var s=t("#room-nav-wrap").outerHeight(!0),o=t(".top-info-bar").outerHeight(!0)||0,n=t("#seat-cart").outerWidth(!0),a=b-20,l=w-30-30-s-20,h=!1,c=!1;if(t("#middle-section").css("margin-left",""),b>=1024){var p=0;t("#legend-wrapper").is(":visible")?(p=t("#legend-wrapper").outerWidth(!0),p>n?(t("#seat-cart").css("margin-left",p-n+10),n=t("#seat-cart").outerWidth(!0)):(t("#legend-wrapper").css("margin-right",n-p+5),p=t("#legend-wrapper").outerWidth(!0)),a=a-p-n-20):a-=2*n,l=w-30-s-o-30,D.rooms[D.currentRoom].room.legends.length>0&&t("#legend-wrapper").css("display","inline-block")}else t("#box-wrap").css("width",a-20);t("#boxes").removeAttr("style"),e>a?(h=!0,t("#box-wrap").css("width",a-20),t("#boxes").css("width",e+15)):t("#box-wrap, #boxes").css("width",e),i>l?(c=!0,t("#box-wrap").css("height",l),t("#boxes").css("height",i+15)):t("#box-wrap, #boxes").css("height",i),1024>b&&t("#legend-wrapper").css("display","none"),t("#box-wrap").attr("data-sec-size",t("#box-wrap").css("width")),r(h,c)}function a(){1024>b?0==D.ie8:t("#legend-wrapper").css("max-height","")}function r(){null!=k&&(k.destroy(),k=null);var e=!1;if((D.rooms[D.currentRoom].room[4]>t("#middle-section").width()||D.rooms[D.currentRoom].room[5]>t("#middle-section").height())&&(e=!0),null==k&&0==D.ie8){if(k=new IScroll("#box-wrap",{keyBindings:!0,scrollbars:!0,scrollX:!0,scrollY:!0,bounce:!1,tap:!0,click:!0,interactiveScrollbars:!0,freeScroll:!0,zoom:!0,zoomMax:30,zoomMin:.1,mouseWheelSpeed:20}),e){var i=l();k.zoom(i)}t("#boxes").css({cursor:"all-scroll"})}}function l(){var e=D.rooms[D.currentRoom].room[4]/(t("#middle-section").width()-20),i=D.rooms[D.currentRoom].room[5]/(t("#middle-section").height()-20),s=Math.max(e,i);return 1/s}function h(t){var e=/^\S+@\S+$/,i=/^[a-z0-9](\.?[a-z0-9]){2,}@g(oogle)?mail\.com$/,s=/^[\s\p{L}]{1,50}$/u,o=t.val();if(""==o)return t.next().text(y.translate("emptyField")).css("display","block"),!1;switch(t.attr("data-field")){case"FirstName":t.next().text("").css("display","inline");break;case"LastName":t.next().css("display","none");break;case"Email":var n=e;if(1==D.gmailNeeded&&(n=i),!n.test(o))return t.next().text(y.translate("emailNotCorrect")).css("display","block"),!1;t.next().css("display","none");break;default:if(!s.test(o))return t.next().text(y.translate("illegalCharactersDetec")).css("display","block"),!1;t.next().css("display","none")}return!0}function c(t,e){this.label=t,this.value=e}function p(){var e=[];return t("#checkout-input-area .check-item").each(function(){var i=[];t(this).find(".custom-input").each(function(){var e=t(this).find(".field-input").attr("data-type");"text"==e?i.push(new c(t(this).find(".l-text").text(),t(this).find(".field-input").val())):"check"==e?i.push(new c(t(this).find(".l-text").text(),t(this).find(".field-input").is(":checked"))):"sel"==e&&i.push(new c(t(this).find(".l-text").text(),t(this).find(".field-input").find(":selected").val()))}),e.push(i)}),e}function d(e,i){t("#checkout-confirm-btn").css("display","none"),t("#checkoput-area-inner .ajax-load").css("display","inline-block");var s=null;s=D.selectedSeats.length>1?t("#prim-mail").val():t("#checkout-input-area .check-item").first().find('.field-input[data-field="Email"]').val(),e=JSON.stringify(e),t.ajax({type:"POST",url:v,data:t("#checkoput-area-inner").serialize()+"&custom="+e+"&action=seatreg_booking_submit&c="+i+"&em="+s+"&pw="+t("#sub-pwd").val(),success:function(e){t("#checkoput-area-inner .ajax-load").css("display","none");var i=!0;try{var o=t.parseJSON(e)}catch(n){i=!1}i?"ok"==o.type&&"mail"==o.text?(t("#email-send").text(s),u()):"ok"==o.type&&"bookings-confirmed-status-2"==o.text?m(o.data,2):"ok"==o.type&&"bookings-confirmed-status-1"==o.text?m(o.data,1):"error"==o.type&&"Wrong captcha"==o.text?(t("#captcha-img").replaceWith(o.data),t("#request-error").text(y.translate("wrongCaptcha")).css("display","block"),t("#checkout-confirm-btn").css("display","inline-block")):"error"==o.type?(t("#checkout-area").css("display","none"),t("#captcha-ref").click(),t("#error-text").html(o.text),t("#error").css("display","block"),t("#checkout-confirm-btn").css("display","inline-block")):"validation-error"==o.type?(t("#captcha-ref").click(),t("#checkout-confirm-btn").css("display","inline-block"),t("#request-error").text(o.text).css("display","block")):(t("#error-text").text(y.translate("somethingWentWrong")),t("#error").css("display","block"),t("#checkout-confirm-btn").css("display","inline-block")):(t("#checkout-area").css("display","none"),t("#error-inner").prepend(y.translate("somethingWentWrong")),t("#error").css("display","block"),t("#checkout-confirm-btn").css("display","inline-block"))},error:function(e){t("#checkout-confirm-btn").css("display","inline-block"),alert(0===e.status?"Not connect.\n Verify Network.":404==e.status?"Requested page not found. [404]":500==e.status?"Internal Server Error [500].":"timeout"===exception?"Time out error.":"abort"===exception?"Ajax request aborted.":"Uncaught Error.\n"+e.responseText)}})}function u(){t("#checkout-area").css("display","none"),t("#email-conf").css("display","block")}function m(e,i){t(".booking-check-url").text(e).attr("href",e),t("#checkout-area").css("display","none"),t("#bookings-confirmed").css("display","block"),1===i?t(".booking-confirmed-header").text(y.translate("bookingsConfirmedPending")):2===i&&t(".booking-confirmed-header").text(y.translate("bookingsConfirmed"))}function f(t,e){null!=k&&(0==P?k.zoom(k.scale-.2,t,e,600):k.zoom(k.scale-.2,t,e,600))}function g(t,e){null!=k&&(0==P?k.zoom(k.scale+.2,t,e,600):k.zoom(k.scale+.2,t,e,600))}var v="../../../../wp-admin/admin-ajax.php",y={translate:function(t){return seatregTranslations&&seatregTranslations.hasOwnProperty(t)?seatregTranslations[t]:void 0}};t(".time").each(function(){var e=new Date(parseInt(t(this).text()));t(this).text(e.format("d.M.Y H:i"))});var b=t(window).width(),w=t(window).height(),x=new Date(1,1,2e3,12,0,0),S=!1,T=200,k=null,E=null,Y=window.navigator.userAgent,P=Y.indexOf("MSIE ");Object.size=function(t){var e,i=0;for(e in t)t.hasOwnProperty(e)&&i++;return i};var X=function(t){if(""==t)return{};for(var e={},i=0;i<t.length;++i){var s=t[i].split("=");2==s.length&&(e[s[0]]=decodeURIComponent(s[1].replace(/\+/g," ")))}return e}(window.location.search.substr(1).split("&"));i.prototype.browserInfo=function(){t("html").hasClass("csstransitions")?this.css3=!0:t("#zoom-controller").css({display:"none"}),document.addEventListener||(this.ie8=!0,t("#box-wrap").css("overflow","auto")),b>=1024&&(this.mobileview=!1)},i.prototype.fillLocationObj=function(){for(var t=this.rooms.length,e=0;t>e;e++)this.locationObj[this.rooms[e].room.uuid]=e},i.prototype.fillCustom=function(t){this.customF=t},i.prototype.init=function(){this.bronSeats=roomsInfo.bronSeats,this.openSeats=roomsInfo.openSeats,this.seatsTotal=roomsInfo.seatsTotal,this.takenSeats=roomsInfo.takenSeats;for(var e in roomsInfo.roomsInfo)if(roomsInfo.roomsInfo.hasOwnProperty(e)){var i=this.locationObj[roomsInfo.roomsInfo[e].roomUuid];this.rooms[i].room.roomBronSeats=roomsInfo.roomsInfo[e].roomBronSeats,this.rooms[i].room.roomCustomBoxes=roomsInfo.roomsInfo[e].roomCustomBoxes,this.rooms[i].room.roomOpenSeats=roomsInfo.roomsInfo[e].roomOpenSeats,this.rooms[i].room.roomSeatsTotal=roomsInfo.roomsInfo[e].roomSeatsTotal,this.rooms[i].room.roomTakenSeats=roomsInfo.roomsInfo[e].roomTakenSeats}for(var s=Object.size(registrations),o=0;s>o;o++)registrations[o].hasOwnProperty("reg_name")?D.addRegistration(registrations[o].seat_id,registrations[o].room_uuid,registrations[o].status,registrations[o].reg_name):D.addRegistration(registrations[o].seat_id,registrations[o].room_uuid,registrations[o].status,null);null!=custF&&D.fillCustom(custF),t(".total-rooms").text(roomsInfo.roomCount),t(".total-open").text(roomsInfo.openSeats),t(".total-bron").text(roomsInfo.bronSeats),t(".total-tak").text(roomsInfo.takenSeats),this.mobileview?(D.paintRoomsNav(),D.paintRoomInfo(),n(D.rooms[D.currentRoom].room.width,D.rooms[D.currentRoom].room.height),D.paintRoomLegends(),D.paintRoom()):(D.paintRoomsNav(),D.paintRoomInfo(),D.paintRoomLegends(),n(D.rooms[D.currentRoom].room.width,D.rooms[D.currentRoom].room.height),D.paintRoom())},i.prototype.getRoomNameFromLayout=function(t){for(var e=this.rooms.length,i=null,s=0;e>s;s++)if(this.rooms[s].room.uuid===t){i=this.rooms[s].room.name;break}return i},i.prototype.addRegistration=function(t,e,i,s){for(var o=this.locationObj[e],n=this.rooms[o].boxes.length,a=0;n>a;a++)if(this.rooms[o].boxes[a].id==t){this.rooms[o].boxes[a].status=1==i?"bronRegister":"takenRegister",null!=s&&(this.rooms[o].boxes[a].hoverText="nohover"===this.rooms[o].boxes[a].hoverText?s:s+"^^"+this.rooms[o].boxes[a].hoverText);break}},i.prototype.paintRoom=function(){var e=document.createDocumentFragment(),i=this.rooms[this.currentRoom].boxes,s=i.length,o=this,n=document.getElementById("box-wrap"),a=document.getElementById("room-is-empty");n.classList.remove("dont-display"),a.classList.add("dont-display"),0===s&&(n.classList.add("dont-display"),a.classList.remove("dont-display"));for(var r=0;s>r;r++){var l=document.createElement("div");l.className="box";var h=!1;if(l.style.top=i[r].yPosition+"px",l.style.left=i[r].xPosition+"px",l.style.backgroundColor=i[r].color,l.style.zIndex=i[r].zIndex,l.style.width=i[r].width+"px",l.style.height=i[r].height+"px","noLegend"!==i[r].legend&&(l.setAttribute("data-legend",i[r].legend),l.setAttribute("data-leg",i[r].legend.replace(/\s+/g,"_").toLowerCase()),h=!0),"true"==i[r].canRegister){l.setAttribute("data-seat",i[r].id);var c=document.createElement("div");c.className="seat-number";var p=document.createTextNode(i[r].seat);c.appendChild(p),l.appendChild(c),h=!0}if("nohover"!==i[r].hoverText){l.setAttribute("data-powertip",i[r].hoverText.replace(/\^/g,"<br>")),l.className=l.className+" bubble-text",h=!0;var d=document.createElement("i");d.className=" fa fa-comment-o comment-icon",l.appendChild(d)}if("noStatus"!==i[r].status){if("bronRegister"==i[r].status){l.setAttribute("data-status","bron");var u=document.createElement("div");u.className="bron-sign",l.appendChild(u)}else if("takenRegister"==i[r].status){l.setAttribute("data-status","tak");var m=document.createElement("div");m.className="taken-sign",l.appendChild(m)}h=!0}h&&(l.className=l.className+" cursor"),this.ie8?l.attachEvent("onclick",function(t){var t=t||window.event,e=t.target||t.srcElement;o.openSeatDialog(e)}):l.addEventListener("tap",function(){o.openSeatDialog(this)},!1),e.appendChild(l)}for(var f=this.selectedSeats.length,g=this.rooms[this.currentRoom].room.name,r=0;f>r;r++)this.selectedSeats[r].room==g&&e.querySelector('.box[data-seat="'+this.selectedSeats[r].id+'"]').setAttribute("data-selectedbox","true");document.getElementById("boxes").appendChild(e),null!==this.rooms[this.currentRoom].room.backgroundImage&&-1!==this.rooms[this.currentRoom].room.backgroundImage.indexOf(".")&&t("#boxes").append('<img class="room-image" src="'+seatregPluginFolder+"uploads/room_images/"+X.c+"/"+this.rooms[this.currentRoom].room.backgroundImage+'" />'),t("#boxes .bubble-text").powerTip({followMouse:!0,fadeInTime:0,fadeOutTime:0,intentPollInterval:10})},i.prototype.paintRoomInfo=function(){t("#current-room-name").text(this.rooms[this.currentRoom].room.name);var e=this.rooms[this.currentRoom].room,i=t(document.createDocumentFragment());i.append('<div class="info-item open-seats"><span>'+y.translate("openSeatsInRoom_")+"</span>"+e.roomOpenSeats+"</div>",'<div class="info-item"><span class="bron-legend"></span> <span>'+y.translate("pendingSeatInRoom_")+"</span>"+e.roomBronSeats+"</div>",'<div class="info-item"><span class="tak-legend"></span> <span>'+y.translate("confirmedSeatInRoom_")+"</span>"+e.roomTakenSeats+"</div>"),t("#room-nav-info-inner").html(i)},i.prototype.paintRoomLegends=function(){t("#legends").empty();var e=this.rooms[this.currentRoom].room.legends.length;e>0?this.mobileview?t("#legend-wrapper").css("display","none"):t("#legend-wrapper").css("display","inline-block"):t("#legend-wrapper, .mobile-legend").css("display","none");for(var i=t(document.createDocumentFragment()),s=0;e>s;s++)i.append(t('<div class="legend-div" data-target-legend='+this.rooms[this.currentRoom].room.legends[s].text.replace(/\s+/g,"_").toLowerCase()+"></div>").append('<div class="legend-box" style="background-color:'+this.rooms[this.currentRoom].room.legends[s].color+'"></div>','<div class="legend-name">'+this.rooms[this.currentRoom].room.legends[s].text+"</div>"));t("#legends").append(i),t("#legends .legend-div").on("click",function(){var e=t(this).data("target-legend"),i=t("#boxes .box[data-leg="+e+"]");i.css("--animationColor",i.css("background-color")),i.one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(){t(this).removeClass("legend-animation")}),i.addClass("legend-animation")}),a()},i.prototype.paintRoomsNav=function(){for(var e=this.rooms.length,i=t(document.createDocumentFragment()),s=this,o=0;e>o;o++){var n=this.rooms[o].room.name,a=t("<div>",{"class":"room-nav-link","data-open":this.rooms[o].room.uuid}).html(n).on("click",function(){s.roomChange(t(this).attr("data-open"))});D.currentRoom==o&&a.addClass("active-nav-link"),a.appendTo(i)}t("#room-nav-items").append(i)},i.prototype.roomChange=function(e){t("#room-nav").removeClass("modal"),t("#modal-bg").css("display","none"),this.currentRoom=this.locationObj[e],null!=k&&(k.destroy(),k=null),null!=E&&(E.destroy(),E=null),t("#room-nav-items .active-nav-link").removeClass("active-nav-link"),t("#room-nav-items").find(".room-nav-link[data-open="+e+"]").addClass("active-nav-link"),t("#boxes").empty(),t("#legends").empty(),this.mobileview<=1024?(this.paintRoomLegends(),this.paintRoomInfo(),n(this.rooms[this.currentRoom].room.width,this.rooms[this.currentRoom].room.height)):(this.paintRoomLegends(),this.paintRoomInfo(),n(this.rooms[this.currentRoom].room.width,this.rooms[this.currentRoom].room.height)),this.paintRoom()},i.prototype.addSeatToCart=function(){var e=document.getElementById("selected-seat").value,i=document.getElementById("selected-seat-nr").value,o=document.getElementById("selected-seat-room").value,n=document.getElementById("selected-room-uuid").value,a=this;this.selectedSeats.push(new s(e,i,o,n)),t(".seats-in-cart").text(this.selectedSeats.length),t('#boxes .box[data-seat="'+e+'"]').attr("data-selectedBox","true");var r=t('<div class="cart-item" data-cart-id="'+e+'" data-room-uuid="'+n+'"></div>'),l=t('<div class="cart-item-nr">'+i+"</div>"),h=t('<div class="cart-item-room">'+o+"</div>"),c=t('<div class="remove-cart-item"><i class="fa fa-times-circle"></i><span style="padding-left:4px">'+y.translate("remove")+"</span></div>").on("click",function(){for(var e=t(this).closest(".cart-item"),i=e.attr("data-cart-id"),s=a.selectedSeats.length,o=0;s>o;o++)if(a.selectedSeats[o].id=i){a.selectedSeats.splice(o,1);break}if(e.remove(),t('#boxes .box[data-seat="'+i+'"]').removeAttr("data-selectedbox"),0==a.selectedSeats.length)t("#seat-cart-info").html("<h3>"+y.translate("selectionIsEmpty")+"</h3><p>"+y.translate("youCanAdd_")+a.spotName+y.translate("_toCartClickTab")+"</p>"),t("#checkout").css("display","none"),t("#seat-cart-rows").css("display","none");else{var n,r=a.selectedSeats.length;n=r>1?r+y.translate("_seatsSelected"):r+y.translate("_seatSelected"),t("#seat-cart-info").text(n)}t(".seats-in-cart").text(a.selectedSeats.length)});r.append(l,h,c),t("#seat-cart-items").append(r),this.closeSeatDialog()},i.prototype.openSeatCart=function(){var e=this.selectedSeats.length;if(0==e)"run"==this.status?(t("#seat-cart-info").html("<h3>"+y.translate("selectionIsEmpty")+"</h3><p>"+y.translate("selectingGuide")+"</p>"),t("#checkout").css("display","none"),t("#seat-cart-rows").css("display","none")):t("#seat-cart-info").html("<h3>"+y.translate("regClosedAtMoment")+"</h3>");else{t("#seat-cart-rows").css("display","block");var i;
i=e>1?e+y.translate("_seatsSelected"):e+y.translate("_seatSelected"),t("#seat-cart-info").text(i),t("#checkout").css("display","inline-block")}t("#seat-cart-popup .cart-popup-inner").addClass("zoomIn"),t("#seat-cart-popup").css("display","block"),t("#modal-bg").css("display","block")},i.prototype.closeSeatCart=function(){t("#seat-cart-popup .cart-popup-inner").removeClass("zoomIn"),t("#seat-cart-popup").css("display","none"),t("#modal-bg").css("display","none")},i.prototype.openCheckOut=function(){var e=this.selectedSeats.length;0!=e&&(t("#seat-cart-popup").css("display","none"),this.generateCheckout(e),t("#checkout-area").css("display","block"),t("#modal-bg").css("display","block"))},i.prototype.openInfo=function(){t("#modal-bg").css("display","block"),t("#extra-info").css("display","block")},i.prototype.closeCheckOut=function(){t("#checkout-area").css("display","none"),t("#modal-bg").css("display","none"),t("#request-error").text("").css("display","none")},i.prototype.generateCheckout=function(e){t("#checkout-input-area").empty();for(var i=t(document.createDocumentFragment()),s=this.customF.length,o=0;e>o;o++){for(var n=t('<div class="check-item"></div>'),a=t('<div class="check-item-head">'+this.spotName+" nr <span>"+this.selectedSeats[o].nr+"</span><br><span>"+this.selectedSeats[o].room+"</span></div>"),r=t(document.createDocumentFragment()),l=this.selectedSeats[o].defFields.length,h=0;l>h;h++){var c=this.generateField(this.selectedSeats[o].defFields[h]);r.append(c)}for(var h=0;s>h;h++){var c=this.generateCustomField(this.customF[h]);r.append(c)}var p=t('<input type="hidden" class="item-id" name="item-id[]" value="'+this.selectedSeats[o].id+'" />'),d=t('<input type="hidden" class="item-nr" name="item-nr[]" value="'+this.selectedSeats[o].nr+'" />'),u=t('<input type="hidden" name="room-uuid[]" value="'+this.selectedSeats[o].roomUUID+'" />');n.append(a,r,p,d,u),i.append(n)}if(e>1){if(1==this.gmailNeeded)var m=t('<div style="text-align:center;margin-top:16px"><label class="field-label">'+y.translate("confWillBeSentTogmail")+'</br> <input type="text" id="prim-mail" class="field-input" data-field="Email"><span class="field-error"></span></label></div>');else var m=t('<div style="text-align:center;margin-top:16px"><label class="field-label">'+y.translate("confWillBeSentTo")+'</br> <input type="text" id="prim-mail" class="field-input" data-field="Email"><span class="field-error"></span></label></div>');i.append(m)}t("#checkout-input-area").append(i),1==e&&1==this.gmailNeeded&&t('#checkout-input-area .field-input[data-field="Email"]').prev().text("Email (Gmail required)")},i.prototype.generateField=function(e){var i;switch(e){case"FirstName":i=y.translate("firstName");break;case"LastName":i=y.translate("lastName");break;case"Email":i=y.translate("eMail")}var s=t('<label class="field-label"><span class="l-text">'+i+"</span></label>"),o=t('<input type="text" name="'+e+'[]" class="field-input" data-field="'+e+'" maxlength="100">'),n=t('<span class="field-error">error</span>');return s.append(o,n),s},i.prototype.generateCustomField=function(e){var i=t('<label class="field-label custom-input"><span class="l-text">'+e.label+"</span></label>");if("text"==e.type)var s=t('<input type="text" name="'+e.label+'[]" class="field-input" data-field="'+e.label+'" data-type="'+e.type+'" maxlength="50">');else if("check"==e.type)var s=t('<input type="checkbox" name="'+e.label+'[]" class="field-input" data-field="'+e.label+'" data-type="'+e.type+'" value="'+e.label+'">');else if("sel"==e.type)for(var s=t('<select name="'+e.label+'[]" class="field-input" data-type="'+e.type+'"></select>'),o=e.options.length,n=0;o>n;n++)s.append('<option value="'+e.options[n]+'">'+e.options[n]+"</option>");var a=t('<span class="field-error">error</span>');return i.append(s,a),i},i.prototype.openModel=function(){t("#modal-bg").css("display","block"),t("#room-nav").addClass("modal")},i.prototype.closeModal=function(){t("#modal-bg").css("display","none"),t("#room-nav").removeClass("modal")},i.prototype.openSeatDialog=function(e){var i=this.paintSeatDialog(e);i&&(t("#modal-bg").css("display","block"),t("#confirm-dialog-mob").css("display","block"),t("#confirm-dialog-mob-inner").removeClass("zoomOut").addClass("zoomIn"))},i.prototype.closeSeatDialog=function(){t("#confirm-dialog-mob").css("display","none"),t("#modal-bg").css("display","none")},i.prototype.paintSeatDialog=function(i){t("#confirm-dialog-mob-hover, #confirm-dialog-mob-legend").empty().css("display","none"),t("#confirm-dialog-mob-text").empty(),t("#confirm-dialog-mob-ok").css("display","none");var s=null,o=null,n=null,a="box",r=this.rooms[this.currentRoom].room,l=this.rooms[this.currentRoom].room.name,h=!1,c=!1,p=t(i);return i.hasAttribute("data-powertip")&&(t("#confirm-dialog-mob-hover").css("display","block"),s=i.getAttribute("data-powertip"),h=!0),i.hasAttribute("data-legend")&&(t("#confirm-dialog-mob-legend").css("display","block"),o=i.getAttribute("data-legend"),h=!0),i.hasAttribute("data-seat")&&(t("#selected-seat").val(i.getAttribute("data-seat")),t("#selected-seat-room").val(r.name),t("#selected-room-uuid").val(r.uuid),a="rbox",n=i.getElementsByTagName("div")[0].firstChild.nodeValue,t("#selected-seat-nr").val(n),h=!0),i.hasAttribute("data-status")&&(a=i.getAttribute("data-status"),h=!0),i.hasAttribute("data-selectedBox")&&(c=!0),null!=s&&t("#confirm-dialog-mob-hover").html('<span class="dialog-hover"></span> <span class="dialog-hover-text">'+s+"</span>"),null!=o&&t("#confirm-dialog-mob-legend").html('Legend: <div class="dialog-legend-box" style="background-color:'+p.css("background-color")+'"></div><span class="dialog-legend-text">'+o+"</span>"),"box"!=a&&(c?t("#confirm-dialog-mob-text").html('<div class="add-seat-text"><h5>'+e(this.spotName)+" "+n+y.translate("_isAlreadySelected")+"</h5></div>"):"rbox"==a&&this.selectedSeats.length<this.seatLimit?"run"==this.status?(t("#confirm-dialog-mob-text").html('<div class="add-seat-text"><h5>'+y.translate("add_")+" "+this.spotName+" "+n+y.translate("_fromRoom_")+" "+l+y.translate("_toSelection")+"</h5></div>"),t("#confirm-dialog-mob-ok").css("display","inline-block")):t("#confirm-dialog-mob-text").html('<div class="add-seat-text"><h5>'+this.spotName+" "+n+y.translate("_fromRoom_")+l+"</h5></div>"):"tak"==a?(t("#confirm-dialog-mob-ok").css("display","none"),t("#confirm-dialog-mob-text").html('<div class="seat-taken-notify"><h5>'+y.translate("this_")+this.spotName+y.translate("_isOccupied")+"</h5></div>")):"bron"==a?(t("#confirm-dialog-mob-ok").css("display","none"),t("#confirm-dialog-mob-text").html('<div class="seat-bron-notify"><h5>'+y.translate("this_")+" "+this.spotName+y.translate("_isPendingState")+"</h5>"+y.translate("regOwnerNotConfirmed")+"</div>")):"rbox"==a&&this.selectedSeats.length>=this.seatLimit&&(t("#confirm-dialog-mob-ok").css("display","none"),t("#confirm-dialog-mob-text").html('<div class="seat-taken-notify">'+y.translate("selectionIsFull")+"</div>"))),h?!0:!1};var D=new i;return D.browserInfo(),t.isEmptyObject(dataReg)?(t("body").append('<div class="under-construction-notify"><span class="icon-construction6 index-icon"></span>'+y.translate("_regUnderConstruction")+"</div>"),!1):(D.fillLocationObj(),t(window).resize(function(){x=new Date,S===!1&&(S=!0,setTimeout(o,T))}),t("#room-nav-btn").on("click",function(){D.openModel()}),t("#close-modal").on("click",function(){D.closeModal()}),t("#seat-cart, .mobile-cart").on("click",function(){D.openSeatCart()}),t("#dialog-close-btn").on("click",function(){D.closeSeatDialog()}),t("#confirm-dialog-mob-ok").on("click",function(){D.addSeatToCart()}),t("#confirm-dialog-mob-cancel").on("click",function(){D.closeSeatDialog()}),t("#room-nav-close").on("click",function(){D.closeModal()}),t("#checkout").on("click",function(){D.openCheckOut()}),t("#checkout-input-area").on("keyup",".field-input",function(){h(t(this))}),t(".refresh-btn").on("click",function(){window.location.reload()}),t("#checkoput-area-inner").submit(function(e){e.preventDefault(),t("#request-error").text("");var i=!0;return t("#checkout-input-area .field-input").each(function(){h(t(this))||(i=!1)}),""==t("#captcha-val").val()?(t("#captcha-val").focus(),void t("#request-error").text("Enter captcha").css("display","block")):void(i&&d(p(),X.c))}),t("#captcha-ref").on("click",function(){t.ajax({type:"POST",url:v,data:{action:"seatreg_new_captcha",cap:"new"},success:function(e){t("#captcha-img").replaceWith(e)}})}),t("#close-time").on("click",function(){t("#time-notify, .modal-bg").css("display","none")}),t(".room-nav-extra-info-btn, #main-header").on("click",function(){D.openInfo()}),t(".mobile-legend").on("click",function(){t(".legend-popup-legends").html(t("#legends").html()),t("#modal-bg").css("display","block"),t("#legend-popup-dialog").css("display","block")}),t(".close-btn").on("click",function(){var e=t(this).closest(".dialog-box");e.css("display","none"),t("#modal-bg").css("display","none"),t("#request-error").text("").css("display","none")}),t(".zoom-action").on("click",function(){null!=k&&k.zoom("in"==t(this).data("zoom")?k.scale+.4:k.scale-.4)}),t(".move-action").on("click",function(){if(null!=k)switch(t(this).data("move")){case"up":k.y<0&&k.scrollBy(0,100);break;case"left":k.x<0&&k.scrollBy(100,0);break;case"right":k.scrollBy(-100,0);break;case"down":{D.rooms[D.currentRoom].room[5]}k.scrollBy(0,-100)}}),null!=D.rooms&&D.init(),void t("#middle-section").on("DOMMouseScroll mousewheel",function(t){t.preventDefault();var e=t.originalEvent.clientX,i=t.originalEvent.clientY;return t.originalEvent.detail>0||t.originalEvent.wheelDelta<0?f(e,i):g(e,i),!1}))}(jQuery);