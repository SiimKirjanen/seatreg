	...
	public function confirmBookings() {
		...
		if($this->_insertState == 1) {
			...
			if ($this->_sendNewPendingBookingNotificationBookerEmail) {
				seatreg_send_pending_booking_email($this->_registrationName, $this->_bookerEmail, $bookingCheckURL, $this->_pendingBookingTemplate, $this->_emailFromAddress, $this->_pendingBookingSubject, array('bg' => $this->_emailBackgroundColor, 'text' => $this->_emailTextColor, 'heading' => $this->_emailHeadingColor));
			}
