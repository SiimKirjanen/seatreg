...
function seatreg_custom_pages() {
	...
	if( isset($_GET['seatreg']) && $_GET['seatreg'] === 'pdf' ) {
		...
		$pdf = new SeatregBookingsPDF( isset($_GET['s1']), isset($_GET['s2']), isset($_GET['s3']), $_GET['code'], assignIfNotEmpty($_GET['calendar-date'], null) );
		$pdf->printPDF();
	...
	if( isset($_GET['seatreg']) && $_GET['seatreg'] === 'xlsx' ) {
		...
		$xlsx = new SeatregBookingsXlsx( isset($_GET['s1']), isset($_GET['s2']), isset($_GET['s3']), $_GET['code'], assignIfNotEmpty($_GET['calendar-date'], null) );
		$xlsx->printXlsx();
