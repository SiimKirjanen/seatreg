<form action="<?php echo esc_url(get_admin_url() . 'admin-post.php'); ?>" method="post" id="create-registration-form">
    ...
    <input type="text" name="new-registration-name" id="new-registration-name" style="margin-left: 12px" maxlength="<?php echo esc_attr(SEATREG_REGISTRATION_NAME_MAX_LENGTH); ?>">
