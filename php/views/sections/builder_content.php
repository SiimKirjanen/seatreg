...
<div id="construction-wrapper">
	...
	<div class="build-controls">
		...
		<div class="update-wrapper">
			...
			<div id="export-layout" title="<?php esc_attr_e('Download the saved layout as a file you can import into a registration that has none yet. Background images are not included, and any seat passwords are in the file in plain text.', 'seatreg'); ?>">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="layout-start__step" data-step="file" style="display:none">
						...
						<p><?php esc_html_e('Use a file exported from a registration. Background images are not included, so upload them again afterwards. Nothing is saved until you press Save.', 'seatreg');?></p>
					</div>
