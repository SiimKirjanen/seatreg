    ...
    public static function insertRegistrationOptions($generatedCode, $registrationData) {
        ...
        $status = $wpdb->insert(
    		...
    		array(
                ...
                'paypal_client_id' => $registrationData->paypal_client_id,
                'paypal_client_secret' => $registrationData->paypal_client_secret,
                'paypal_rest_sandbox_mode' => $registrationData->paypal_rest_sandbox_mode,
                'payment_completed_set_booking_confirmed_paypal_rest' => $registrationData->payment_completed_set_booking_confirmed_paypal_rest,
